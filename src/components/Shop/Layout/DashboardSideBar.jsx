...
const DashboardSideBar = ({ active }) => {
  return (
    <div className="w-full h-[90vh] bg-white shadow-sm overflow-y-scroll top-0 left-0 sticky z-10">
      {/* single item */}
      <div className=" w-full flex items-center p-4">
        <Link to="/dashboard" className="w-full flex items-center">
          ...
          />
          <h5
            className={` hidden lg:block pl-2 font-[400] text-[18px] ${
              active === 1 ? "text-[crimson]" : "text-[#5555]"
            }`}
          >
            Dashboard
          </h5>
